...
!function i(o, a, r) {
  ...
  1: [function (s, K, B) {
    ...
    function T(e, t, n) {
      v(e, x, t, t.onFileProgress, n);
    }
    y.platform === y.Platform.TAOBAO_MINI_GAME && (s = globalThis.__taobaoRequire);
    function F(e, n, i) {
      a(e, function (e, t) {
        e ? i(e) : k(t, n, i);
      });
    ...
    m.downloadScript = n, m._downloadArrayBuffer = function (e, t, n) {
    ...
    }, m._downloadJson = E, e.parsePVRTex = F, e.parsePKMTex = C, e.parseASTCTex = A, e.parsePlist = O, m.register({
      ".js": n,
      ".mp3": T,
      ".ogg": T,
      ".wav": T,
      ...
      ".rm": T,
      ".rmvb": T,
      bundle: function bundle(e, t, r) {
        var n,
          i,
          c,
          o = cc.path.basename(e),
        ...
        _[o] ? (n = (y.platform === y.Platform.TAOBAO_MINI_GAME ? "" : "subpackages/").concat(o, "/config.").concat(a, "json"), h(o, t.onFileProgress, function (e) {
          ...
          var i, o, a;
          e ? r && r(e) : n.isZip ? (e = n.zipVersion, e = "".concat(c, "/res.").concat(e ? "".concat(e, ".") : "", "zip"), i = e, o = t, a = function a(e, t) {
            e ? r && r(e) : (n.base = "".concat(t, "/res/"), y.platform === y.Platform.ALIPAY_MINI_GAME && y.os === y.OS.ANDROID && (e = "".concat(t, "res/"), u.accessSync({
              path: e
  ...
  3: [function (e, t, n) {
    ...
    cc.assetManager.cacheManager = t.exports = {
      ...
      _write: function _write() {
        m = null, r("".concat(this.cacheDir, "/").concat(this.cachedFileName), JSON.stringify({
          files: this.cachedFiles._map,
          version: this.version
        }), "utf8");
      },
      ...
      cacheFile: function cacheFile(e, t, n, i, o) {
      ...
      clearLRU: function clearLRU() {
        if (!_) {
          ...
          var n = [],
            i = this;
          this.cachedFiles.forEach(function (t, e) {
          ...
          }), n.length < 3 ? console.warn("Insufficient storage, cleaning now") : n.length = Math.floor(n.length / 3);
          for (var e = 0, t = n.length; e < t; e++) {
            var o = "".concat(cc.assetManager.utils.getUuidFromURL(n[e].originUrl), "@native");
            cc.assetManager.files.remove(o), this.cachedFiles.remove(n[e].originUrl);
          }
          clearTimeout(m), this._write(), setTimeout(function e() {
            var t = n.pop();
            i._removePathOrFile(t.originUrl, t.url), 0 < n.length ? setTimeout(e, i.deleteInterval) : _ = !1;
          }, i.deleteInterval);
        }
      },
      ...
      _removePathOrFile: function _removePathOrFile(e, t) {
        !this._isZipFile(e) || this._isZipFile(t) ? s(t, this._deleteFileCB.bind(this)) : (l(t, !0), this._deleteFileCB());
      },
      _deleteFileCB: function _deleteFileCB(e) {
        e || (this.outOfStorage = !1);
      },
      makeBundleFolder: function makeBundleFolder(e) {
        c("".concat(this.cacheDir, "/").concat(e), !0);
      },
      unzipAndCacheBundle: function unzipAndCacheBundle(t, e, n, i) {
        var o = Date.now().toString(),
          a = "".concat(this.cacheDir, "/").concat(n, "/").concat(o).concat(y++),
          r = this;
  ...
  7: [function (e, t, n) {
    ...
    cc.SpriteFrame && (cc.SpriteFrame.prototype._checkPackable = function () {
      var e,
        t,
        n,
        i = cc.internal.dynamicAtlasManager;
