...
import { AuthSchema, AuthSerializer } from "@utcp/sdk";
...
import { AuthSchema as AuthSchema2 } from "@utcp/sdk";
import { Serializer as Serializer2 } from "@utcp/sdk";
...
import { AuthSchema as AuthSchema3 } from "@utcp/sdk";
import { Serializer as Serializer3 } from "@utcp/sdk";
...
import { UtcpManualSerializer as UtcpManualSerializer2 } from "@utcp/sdk";
var StreamableHttpCommunicationProtocol = class {
  ...
  async registerManual(caller, manualCallTemplate) {
    ...
    try {
      ...
      const utcpManual = new UtcpManualSerializer2().validateDict(JSON.parse(responseText));
      ...
      return {
        manualCallTemplate: provider,
        manual: new UtcpManualSerializer2().validateDict({ tools: [] }),
        success: false,
...
import { UtcpManualSerializer as UtcpManualSerializer3 } from "@utcp/sdk";
var SseCommunicationProtocol = class {
  ...
  async registerManual(caller, manualCallTemplate) {
    ...
    try {
      ...
      const responseText = await response.text();
      const utcpManual = new UtcpManualSerializer3().validateDict(JSON.parse(responseText));
      this._logInfo(`Discovered ${utcpManual.tools.length} tools from '${provider.name}'`);
      return {
        manualCallTemplate: provider,
        manual: utcpManual,
      ...
      return {
        manualCallTemplate: provider,
        manual: new UtcpManualSerializer3().validateDict({ tools: [] }),
        success: false,
        errors: [error.message || String(error)]
      };
    }
